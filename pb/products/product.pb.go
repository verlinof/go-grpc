...
type Products struct {
	...
	Data          []*Product             `protobuf:"bytes,2,rep,name=data,proto3" json:"data,omitempty"` //Repeated digunakan untuk array
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Page struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Page          *int64                 `protobuf:"varint,1,opt,name=page,proto3,oneof" json:"page,omitempty"` // Optional digunakan untuk dapat NULL
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_product_proto_rawDesc = string([]byte{
	...
	0x67, 0x72, 0x70, 0x63, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x42, 0x29, 0x5a, 0x27, 0x67,
	0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x76, 0x65, 0x72, 0x6c, 0x69, 0x6e,
	0x6f, 0x66, 0x2f, 0x67, 0x6f, 0x2d, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x70, 0x62, 0x2f, 0x70, 0x72,
